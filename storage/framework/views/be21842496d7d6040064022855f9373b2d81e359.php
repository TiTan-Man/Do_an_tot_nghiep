                                          ...
                                          <div class="row">
                                              <div class="col-xs-6">
                                                  ...
                                                  <input type="number" class="form-control" name="S"
                                                      placeholder="Số lượng" value="<?php echo e(old('S')); ?>">
                                                      <label>M</label>
                                                  <input type="number" class="form-control" name="M"
                                                      placeholder="Số lượng" value="<?php echo e(old('M')); ?>">
                                                      <label>L</label>
                                                  <input type="number" class="form-control" name="L"
                                                      placeholder="Số lượng" value="<?php echo e(old('L')); ?>">
                                                      <label>XL</label>
                                                  <input type="number" class="form-control" name="XL"
                                                      placeholder="Số lượng" value="<?php echo e(old('XL')); ?>">
                                              </div>
                                              <div class="col-xs-6">
                                                <label>Thứ tự</label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SAVE\do_an\TopFashion\public_html\resources\views/admin/pages/cms_products/create.blade.php ENDPATH**/ ?>