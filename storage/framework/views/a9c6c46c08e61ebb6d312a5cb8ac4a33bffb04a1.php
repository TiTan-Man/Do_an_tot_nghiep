    ...
    <div class="box box-primary">
      ...
      <form role="form" action="<?php echo e(route(Request::segment(2) . '.store')); ?>" method="POST">
        ...
        <div class="box-footer">
          ...
          <button type="submit" class="btn btn-danger pull-right btn-sm mg-5"  >Lưu</button>
        </div>
      </form>
    </div>
  </section>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SAVE\do_an\TopFashion\public_html\resources\views/admin/pages/cms_posts/create.blade.php ENDPATH**/ ?>