                                ...
                                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                                    <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                                        ...
                                        <tr class="valign-middle">
                                            ...
                                            <td>
                                                <input type="text" id="title_<?php echo e($row->id); ?>"
...
<script>
    function saveService(id) {
        ...
        $.ajax({
            url: '<?php echo e(route('cms_product.save_ajax')); ?>',
            type: 'POST',
            data: {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SAVE\do_an\TopFashion\public_html\resources\views/admin/pages/cms_products/index.blade.php ENDPATH**/ ?>